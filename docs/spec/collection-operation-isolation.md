...
| External I/O and reentry inside policy               | Real risks, but not currently rejected automatically                            | [Contract documentation issue](../issues/closed/0005-policy-io-contract/issue.md)   |
