...
* The following workspace dependencies were updated
  * devDependencies
    * takibi bumped to 0.5.0
  * peerDependencies
    * takibi bumped to 0.5.0

## [0.1.5](https://github.com/kentrino/takibi/compare/hono-adapter-v0.1.4...hono-adapter-v0.1.5) (2026-09-16)
...
* The following workspace dependencies were updated
  * devDependencies
    * takibi bumped to 0.4.1
  * peerDependencies
    * takibi bumped to 0.4.1

## [0.1.4](https://github.com/kentrino/takibi/compare/hono-adapter-v0.1.3...hono-adapter-v0.1.4) (2026-09-15)
...
* The following workspace dependencies were updated
  * devDependencies
    * takibi bumped to 0.4.0
  * peerDependencies
    * takibi bumped to 0.4.0

## [0.1.3](https://github.com/kentrino/takibi/compare/hono-adapter-v0.1.2...hono-adapter-v0.1.3) (2026-09-15)
...
## [0.1.2](https://github.com/kentrino/takibi/compare/hono-adapter-v0.1.1...hono-adapter-v0.1.2) (2026-09-14)
...
## [0.1.1](https://github.com/kentrino/takibi/compare/hono-adapter-v0.1.0...hono-adapter-v0.1.1) (2026-09-14)
