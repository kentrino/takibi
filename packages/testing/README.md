...
assembly only through `@takibi/worker-runtime/testing-bridge`
and depends on `@takibi/api`, `@takibi/storage`, and
...
factories. `takibi/testing` remains a thin compatibility
