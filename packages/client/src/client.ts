...
import type { StorageListOptions, TakibiResult } from "@takibi/shared-types";
import type { ClientOf, TakibiDefinitionCarrier } from "./client-types";

export type { ClientOf, InferHandlerActions, InferHandlerCollections } from "./client-types";

type ClientCollectionOperation = "add" | "set" | "get" | "update" | "delete" | "list";
...
export function createClient<H extends TakibiDefinitionCarrier>(
  baseUrl: string,
